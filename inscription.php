              ...
              <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                  ...
                  <form id="contactForm" method="POST">
                    ...
                    <div class="form-floating mb-3 ">
                      <input id="checkbox" name="reglement" type="checkbox" placeholder="567 route de saint omer" /> <a
                        class="text-dark" href="Reglement.php"> Reglement</a> Lu et Approuvé
                    ...
                    <div class="d-grid"><button class="btn btn-primary btn-lg " id="submitButton" type="submit"
                        name="submitButton">Continuer l'inscription</button></div>
                  </form>
                </div>
              </div>
            </div>
